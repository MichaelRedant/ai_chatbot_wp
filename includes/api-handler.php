...
EOT;
    ...
    $topic_prompts = [
        'klantenportaal' => [
            'NL' => 'Focus op het klantenportaal en gebruik context over klantlogin, facturen, betalingen en supportpagina\'s binnen het portal.',
            'FR' => 'Concentrez-vous sur le portail client et utilisez des informations concernant les accès, factures, paiements et pages d\'assistance du portail.'
        ],
        'boekhoudprogramma' => [
            'NL' => 'Focus op het boekhoudprogramma, inclusief boekhouding, btw, dagboeken en rapportages.',
            'FR' => 'Concentrez-vous sur le logiciel comptable, notamment la comptabilité, la TVA, les journaux et rapports.'
        ]
    ];
    $topic_context = '';
    if ($topic && isset($topic_prompts[$topic])) {
        $topic_context = $topic_prompts[$topic][$lang] ?? '';
    }
