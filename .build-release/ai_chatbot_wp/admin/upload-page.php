    ...
    if (isset($_POST['octopus_pdf_upload_nonce']) && wp_verify_nonce($_POST['octopus_pdf_upload_nonce'], 'octopus_pdf_upload')) {
        if (!empty($_FILES['octopus_pdf_file']['name'])) {
            ...
            if (!class_exists(Parser::class)) {
                echo '<div class="error"><p>PDF parser ontbreekt op de server (vendor/autoload.php of Smalot parser niet beschikbaar).</p></div>';
                ?>
                <div class="wrap">
                    <h1>PDF Beheer</h1>
            ...
            if (!isset($uploaded['error'])) {
                ...
                try {
                    ...
                    echo '<div class="error"><p>Fout tijdens PDF parsing: ' . esc_html($e->getMessage()) . '</p></div>';
                    ?>
                    <div class="wrap">
                        <h1>PDF Beheer</h1>
                        <form method="post" enctype="multipart/form-data">
